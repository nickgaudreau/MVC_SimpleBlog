...
namespace SimpleBlog.Areas.Admin.Controllers
{
    ...
    public class UsersController : Controller
    {
        ...
        public ActionResult New()
        {
            ...
            {
                // wil get our roles from db and make a list of it
        ...
        {
            var user = new User();
            // compare manip the selected vs what the user have
        ...
        public ActionResult Edit(int id, UsersEdit form)
        {
            ...
            // sync newly edited/selected toles to user
            SyncRoles(form.Roles, user.Roles);
        ...
        //not enough will need JavaScript to force a POST
        [HttpPost, ValidateAntiForgeryToken]
        ...
        private void SyncRoles(IList<RoleCheckBox> checkBoxes, IList<Role> roles)
        {
            ...
            // add the roles to the IList if does not contain
            foreach (var toAdd in selectedRoles.Where(t => !roles.Contains(t)))
            {
                roles.Add(toAdd);
            }

            // if role does not gets selected but was in the roles -> remove it
